                  ...
                  <div className={styles.orderViewMain}>
                    <div className={styles.orderViewMainInfor}>
                      <div className={styles.orderViewMainInforItem}>
                        ...
                        <div className={styles.orderInforCustomer}>
                          <span>Phạm Đình Trí</span>
                          <span>0385394673</span>
                          <span>dinhtriqs111@gmail.com</span>
                          <span>
                            Tổ 2, thôn Tam Hòa, TT Đông Phú, huyện Quế Sơn, tỉnh
                            Quảng Nam
                          </span>
                        </div>
                        <div className={styles.orderViewInforNote}>
                          Ghi chú: <span>Gói trong 1 kiện hàng</span>
                        </div>
                      </div>
                      <div className={styles.orderViewMainInforItem}>
                        <div>
                    ...
                    <div className={styles.orderViewProduct}>
                      <table>
                        <thead>
                          <tr>
                            <th>Sản phẩm</th>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <div className={styles.option}>
                                <span><b>Màu sắc:</b>Đen</span>
                                <span><b>Loại:</b>Bluetooth</span>
                            </div>
                          </tr>
                        </tbody>
                      </table>
