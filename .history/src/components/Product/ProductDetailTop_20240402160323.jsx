...
const ProductDetailTop = ({idProduct, loading}) => {
  ...
  const handleClickZoomIn = () => {
    ...
    sliderItemActive.style.transform = `scale(1.${zoom > 3 ? 4 : zoom + 4})`;
    setZoom(zoom > 3 ? 4 : zoom + 4);
    console.log(zoom)
  }
  const handleClickZoomOut = () => {
    ...
    sliderItemActive.style.transform = `scale(1.${zoom < 1 ? 0 : zoom - 4})`;
    setZoom(zoom < 1 ? 0 : zoom - 4);
    console.log(zoom);
  }
    return (
      <>
