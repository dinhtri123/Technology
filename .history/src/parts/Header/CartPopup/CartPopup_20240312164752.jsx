...
const CartPopup = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await request.get("addToCarts");
  ...
  return (
    <>
      <div onClick={hanldePopupCart} ref={cartWrapperRef}>
          ...
          {product.length > 0 && (
            <div className={styles.inforCartSumary}>
              ...
              <div className={"btnDoubleCustom"}>
                <span>
                  <Link to="/thanhtoan" onClick={handleNaviCart}>
                    <Button>Thanh Toán</Button>
                  </Link>
                </span>
                <span>
                  <Link to="/giohang" onClick={handleNaviCart}>
