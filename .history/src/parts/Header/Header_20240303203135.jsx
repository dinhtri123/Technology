...
const Header = () => {
  ...
  const handleShowMenuMobile = (e) => {
    ...
    let getTextMenuActive =  menuMobileRef.current.querySelector("a.active").textContent;
    let getDataMenuActive = e.currentTarget.querySelector(
      "[data-text-menu-active]");
    getDataMenuActive.textContent = getTextMenuActive;
  };
            ...
            <div className={styles.headerIconMenuMobile}>
              ...
              >
                ...
                <div className={styles.menuItemActive}>
                  <span className={styles.itemActive} data-text-menu-active>Menu</span>
