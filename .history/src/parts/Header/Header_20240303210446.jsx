...
const Header = () => {
  ...
  const handleCloseLogin = () => {
    console.log(document.querySelector("[data-login]").classList);
    Array.from(document.querySelectorAll("[data-login]")).map((item) => {
      
      item.classList.opacity = '0';
      item.classList.visibility = "hidden";
    });
  };
            ...
            <div className={styles.headerIconMenuMobile}>
              ...
              >
                ...
                <div className={styles.menuItemActive}>
                  <span className={styles.itemActive} data-text-menu-active>
                    Menu
                  </span>
