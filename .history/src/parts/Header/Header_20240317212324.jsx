...
const Header = () => {
  ...
  const refStickyHeader = useRef(null);
  console.log("🚀 ~ Header ~ refStickyHeader:", refStickyHeader)
  ...
  useEffect(() => {
    window.onscroll = () => {
      ...
      if(getHeightScroll > 350) {
        refStickyHeader.currentTarget.classList.add(styles.activeScroll)
      }else {
        refStickyHeader.currentTarget.classList.remove(styles.activeScroll);
      }
    }
  },[])
